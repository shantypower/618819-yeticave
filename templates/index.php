    ...
    <ul class="lots__list">
        ...
        <li class="lots__item lot">
            <div class="lot__image">
                <img src="<?=text_clean($item['img'])?>" width="350" height="260" alt="">
            </div>
            <div class="lot__info">
                <span class="lot__category"><?=text_clean($item['category'])?></span>
                <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=text_clean($item['name'])?></a></h3>
